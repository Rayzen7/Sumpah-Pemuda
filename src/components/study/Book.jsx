...
function Book() {
  ...
  return (
    <div data-aos="fade-up" data-aos-duration="1000">
      <h1 className="text-center font-poppins font-[600] text-[32px] lg:text-[40px] -mt-20 lg:mt-20 mb-5">Buku <span className="text-red-600">Sumpah Pemuda</span></h1>
      <HTMLFlipBook width={window.innerWidth < 768 ? 400 : 500} height={window.innerWidth < 768 ? 500 : 600} className="mx-auto lg:mt-0 -mt-28 lg:scale-100 scale-[70%] font-poppins block overflow-hidden pb-24">
        <div className="demoPage bg-[rgb(196,1,1)] rounded-xl p-10 shadow-2xl">
          <div className="flex flex-col w-full h-full justify-center items-center text-white gap-5">
            ...
            <div className="text-center">
              <h2 className="text-[32px] font-bold">SUMPAH PEMUDA</h2>
