import { aboutTokoh } from "../../assets/About"

const Char = () => {
  return (
    <div className="font-poppins mt-28" data-aos="fade-up" data-aos-duration="800">
        <h1 className="text-center font-[600] text-[29px] lg:text-[40px]">Tiga <span className="text-red-600">Serangkai</span></h1>
        <div className="flex justify-center items-center gap-12 lg:gap-9 mt-8 flex-wrap">
            {aboutTokoh.map((item, i) => (
                <div key={i}>
