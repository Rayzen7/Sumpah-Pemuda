...
const Welcome = () => {
  return (
    <div data-aos="fade-up" data-aos-duration="1000">
        <div className="flex flex-col items-center justify-center w-full h-[120vh] lg:h-[130vh] mb-16 font-poppins text-center gap-3 bg-center object-cover bg-cover bg-no-repeat bg" 
        style={{backgroundImage: `url(${bg})`}}>
            <h1 className="font-[600] lg:text-[42px] text-[22px] -mt-52 lg:-mt-44">Selamat Datang di Website Edukasi <br className='br'/> <span className="text-red-600">Sejarah Sumpah Pemuda</span></h1>
