...
const Navbar = () => {
  ...
  return (
    <div className='w-full z-40 lg:h-[14vh] h-[11vh] bg-white flex justify-between items-center lg:px-[45px] fixed px-5'>
      ...
      <div className={`font-poppins flex lg:flex-row flex-col lg:h-auto lg:pl-0 pl-12 lg:mt-0 -mt-12 h-[100vh] top-0 right-0 lg:bg-transparent bg-white lg:w-auto w-[200px] justify-center lg:relative absolute lg:items-center items-start gap-12 font-[600] cursor-pointer text-[17px] ${visibilityClass}`}>
      ...
      <i className='bx bx-list-ul text-black text-[30px] list z-50 relative' onClick={toggleList}></i>
    </div>
  )
}
